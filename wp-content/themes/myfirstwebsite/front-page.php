...
<div class="page-banner">
  ...
  <div class="page-banner__content container t-center c-white">
    <h1 class="headline headline--large">Welcome! puskar</h1>
    <h2 class="headline headline--medium">Please visit Bhatta Uiversity.</h2>
    <h3 class="headline headline--small">This is the one of the top university in the world.</h3>
