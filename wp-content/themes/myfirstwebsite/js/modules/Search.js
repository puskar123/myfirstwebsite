import $ from 'jquery';
class Search {
    //1. discribe and create/initiate our object
    constructor() {
        this.addSearchHTML();
        ...
        if (this.searchField.val() != this.previousValue) {
            ...
            if (this.searchField.val()) {
                if(this.isSpinnerVisible) {
                    this.resultsDiv.html('<div class="spinner-loder"></div>');
        ...
        $.getJSON(universityData.root_url + '/wp-json/university/v1/search?term=' + this.searchField.val(),  (results) => {
            ...
            <div class="row">
                <div class="one-third">
                    ...
                    ${results.generalInfo.map(item => `<li><a href="${item.permalink}">${item.title}</a> by ${item.postType == 'post' ? `${item.authorName}` : ''}</li>`).join('')}
                ...
                <div class="one-third">
                    ...
                    <div class="event-summary__content">
                      <h5 class="event-summary__title headline headline--tiny"><a href="${item.permalinkl}">${item.title}</a></h5>
    ...
    openOverlay() {
        ...
        console.log("our open metho just ran");
